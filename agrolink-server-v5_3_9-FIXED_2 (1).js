...
async function initializeDatabase() {
    try {
        ...
        await rawDb.exec(`
            ...
            -- 📩 Web Push Notification Subscriptions Tablosu
            CREATE TABLE IF NOT EXISTS push_subscriptions (
                id TEXT PRIMARY KEY,
                userId TEXT NOT NULL,
            ...
            -- Push subscriptions için indeksler
            CREATE INDEX IF NOT EXISTS idx_push_subscriptions_userId ON push_subscriptions(userId);
            CREATE INDEX IF NOT EXISTS idx_push_subscriptions_endpoint ON push_subscriptions(endpoint);
            CREATE INDEX IF NOT EXISTS idx_push_subscriptions_isActive ON push_subscriptions(isActive);
